...
VALUES
 -- order 10000000
 (10000000,10000000,10000000,2,NULL,'2025-08-02 10:00:00',N'10000000'),
 (10000001,10000000,10000006,1,N'Ok','2025-08-02 10:00:00',N'10000000'),

 -- order 10000001
 (10000002,10000001,10000002,1,NULL,'2025-08-03 11:00:00',N'10000000'),
 (10000003,10000001,10000007,3,NULL,'2025-08-03 11:00:00',N'10000000'),

 -- order 10000002
 (10000004,10000002,10000008,1,N'Nice','2025-08-04 12:00:00',N'10000000'),

 -- order 10000003
 (10000005,10000003,10000010,2,NULL,NULL,N'10000000'),

 -- order 10000004
 (10000006,10000004,10000011,5,NULL,NULL,N'10000000'),

 -- order 10000005
 (10000007,10000005,10000005,1,NULL,'2025-08-07 16:00:00',N'10000000'),
 (10000008,10000005,10000006,2,NULL,'2025-08-07 16:00:00',N'10000000'),

 -- order 10000006
 (10000009,10000006,10000012,1,NULL,'2025-08-08 17:00:00',N'10000000'),
 (10000010,10000006,10000013,2,NULL,'2025-08-08 17:00:00',N'10000000'),

 -- order 10000007
 (10000011,10000007,10000014,1,NULL,NULL,N'10000000'),
 (10000012,10000007,10000015,2,NULL,NULL,N'10000000'),

 -- order 10000008
 (10000013,10000008,10000016,1,NULL,NULL,N'10000000'),

 -- order 10000009
 (10000014,10000009,10000017,10,NULL,'2025-08-10 10:40:00',N'10000000'),

 -- order 10000010
 (10000015,10000010,10000018,1,N'Returned reason',NULL,N'10000000'),

 -- order 10000011
 (10000016,10000011,10000019,4,NULL,'2025-08-12 14:00:00',N'10000000'),

 -- order 10000012
 (10000017,10000012,10000020,1,NULL,'2025-08-13 15:00:00',N'10000000'),
 (10000018,10000012,10000021,2,NULL,'2025-08-13 15:00:00',N'10000000'),

 -- order 10000013
 (10000019,10000013,10000022,1,NULL,'2025-08-14 16:00:00',N'10000000'),

 -- order 10000014
 (10000020,10000014,10000023,1,NULL,NULL,N'10000000'),
...
ALTER TABLE dbo.order_products
ADD returnStatus NVARCHAR(50) NULL; -- Trạng thái: processing, confirmed, rejected
GO

ALTER TABLE dbo.order_products
ADD returnReason NVARCHAR(1000) NULL DEFAULT N'';
GO
...
-- 1. Xóa cột 'currentLocation' cũ (nếu nó đang là NVARCHAR)
-- (Nếu bạn đã đổi nó thành BIGINT rồi thì có thể bỏ qua bước này)
ALTER TABLE [dbo].[Order_Products] DROP COLUMN currentLocation;
GO

-- 2. Thêm lại cột 'currentLocation' làm FOREIGN KEY
ALTER TABLE [dbo].[Order_Products]
ADD currentLocation INT NULL; -- Thêm cột (hoặc đổi kiểu dữ liệu nếu đã có)
GO

ALTER TABLE [dbo].[Order_Products]
ADD CONSTRAINT FK_OrderProduct_Address
FOREIGN KEY (currentLocation) REFERENCES [dbo].[Addresses](id);
GO

-- 3. (QUAN TRỌNG) Cập nhật trạng thái "Processing"
-- Chúng ta cần một địa chỉ để đại diện cho "Đang xử lý".
-- Logic nhất là dùng địa chỉ của Seller.
-- Lấy ID địa chỉ của Seller (giả sử Seller có isSeller = 1)
DECLARE @SellerAddressId INT;
SELECT TOP 1 @SellerAddressId = address_id FROM [dbo].[Users] WHERE isSeller = 1;

-- Cập nhật tất cả các đơn hàng cũ đang ở trạng thái 'Processing'
-- (hoặc các đơn hàng mới) về ID địa chỉ của Seller.
UPDATE [dbo].[Order_Products]
SET currentLocation = @SellerAddressId
WHERE currentLocation IS NULL OR id > 0; -- (Cập nhật logic WHERE nếu cần)
GO
